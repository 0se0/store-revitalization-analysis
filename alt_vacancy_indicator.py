...
<div class="chart-box">
<div class="note" style="margin-top:0.75rem;">※ "20분기 추이"는 각 행별 최소~최대 범위 내 상대적 변화만 보여주는 스파크라인이다(행 간 절대비교용이 아님).<br>
 위험도는 최근4분기 폐업률이 아니라 전체 기간(2021 1분기~2025 4분기) 점포수 순증감률로 판정하므로,<br>
 하락이 과거에 집중되고 최근엔 이미 바닥까지 줄어 안정된 상권(예: 신림종합시장)은 최근폐업률이 0%여도 고위험으로 분류될 수 있다.</div><br><br>
